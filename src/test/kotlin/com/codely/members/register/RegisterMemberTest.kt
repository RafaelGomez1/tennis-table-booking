package com.codely.members.register
...
import com.codely.members.primaryadapter.rest.register.RegisterMemberController
import com.codely.members.primaryadapter.rest.register.RegisterMemberDTO
...
class RegisterMemberTest {
    ...
    fun `should register an academy beginner member`() = runTest {
        ...
        val type = member.type as com.codely.members.domain.Membership.AcademyBeginner
    ...
    fun `should register a competition member`() = runTest {
        ...
        val type = member.type as com.codely.members.domain.Membership.Competition
